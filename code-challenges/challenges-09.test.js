...
const returnNames = (arr) => {
  // Solution code here...
  // Documentation: I used the "flatten an array of arrays" example on this MDN webpage as a clue to solve the challenge https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/reduce
  const newArray = arr.reduce((acc, currVal) => acc.concat(currVal.name), []);
  return newArray;
};
...
const reversedString = (str) => {
  // Solution code here...
  // Carly Dekock https://github.com/carlydekock helped me with this one
  const splitString = str.split('');
  // console.log('split str', str.split(''));
  const reversedString = splitString.reduce((accumulator, letter) => {
    // console.log('instance', letter + accumulator);
