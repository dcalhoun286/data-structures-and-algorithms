...
------------------------------------------------------------------------------------------------ */
//Glenn Clark https://github.com/elliron helped me with this challenge
const isNum = (input) => {
  // Solution code here...
  const digits = /\d+/g;
...
------------------------------------------------------------------------------------------------ */
// Stephen Webber https://github.com/offgridauthor helped me with this challenge
const isCapitalized = (str) => {
  // Solution code here...

  // documentation:
  const capitalLetters = str.match(/[A-Z][a-zA-Z]*/g);
...
// Glenn Clark http://github.com/elliron helped me with this challenge

const citiesAtoJ = (arr) => {
  // Solution code here...
  const citiesAtojPattern = /^[A-J]+\w+/g;
  const citiesAtojArray = [];
  arr.forEach((city) => {
    const cityThatMatches = city.match(citiesAtojPattern);
    if (cityThatMatches !== null) {
      citiesAtojArray.push(cityThatMatches[0]);
    }
  });
