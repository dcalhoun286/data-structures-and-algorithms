...
function sayHello(request, response){
  ...
  // Stephen Webber helped me debug
...
const oddValues = (arr) => {
  // Solution code here...
  const result2 = arr.filter(value => value % 2 !== 0);
  // Documentation for array.prototype.filter() - https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/filter
