...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach((apple) => {
    ...
    // if(characters[apple].children.length !== 0) {
    //   // console.log(characters[i].children);
    //   result = true;
    // } else if (characters[apple].children.length === 0) {
    //   result = false;
    // }

    if (Object.values(apple)[0] === character && Object.values(apple)[2].length !== 0) {
      result = true;
    } else if (Object.values(apple)[0] === character && Object.values(apple)[2].length === 0) {
      result = false;
    }
