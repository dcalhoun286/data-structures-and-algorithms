...
const sortBackwards = (arr) => {
  ...
  // documentation: I used the following links as a guide to build the function -- https://repl.it/@ncarignan/301d70-Arrayprototypesort#index.js and https://stackoverflow.com/questions/6567941/how-does-sort-function-work-in-javascript-along-with-compare-function
  arr.sort((a, b) => {
    if(b > a) {
      return 1;
    } else if (a > b) {
